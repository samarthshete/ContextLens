  ...
  return {
    ...
    api: {
      ...
      listDatasets: vi.fn().mockResolvedValue([
        { id: 1, name: 'Routing test DS', description: null, created_at: '2026-03-20T12:00:00.000Z' },
      ]),
      ...
      getRun: vi.fn(),
      listDiagnosisTimingSessions: vi.fn().mockResolvedValue([]),
      createDiagnosisTimingSession: vi.fn().mockResolvedValue({
        id: 1,
        run_id: 1,
        mode: 'manual',
      ...
      patchDiagnosisTimingSession: vi.fn().mockImplementation(async (_rid: number, sid: number) => ({
        id: sid,
        run_id: 1,
        mode: 'manual',
        started_at: '2026-01-01T00:00:00Z',

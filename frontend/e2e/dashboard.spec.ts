    ...
    route.fulfill({
      json: {
        ...
        repeated_sampling_note:
          '2 runs across 2 unique query cases in this slice (4 query cases registered); repeated sampling makes run count exceed unique queries when cells repeat the same cases.',
        diagnosis_timing: {
          sessions_count: 0,
